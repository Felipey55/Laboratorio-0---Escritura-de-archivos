...
public class Discotienda
{
    ...
    public void generarInformeDiscos () throws FileNotFoundException 
    {
    	...
    	//Escribir con la puma en el archivo
    	pluma.println("Reporte de discos");
    	pluma.println("=================");
    	
    	//Escribir un reporte de discos con nombre, artista, genero y precio
    	for(int i = 0;i<discos.size();i++) 
    	{
     ...
     * @throws FileNotFoundException
     */
    private void generarInformeDiscosCostosos (String pGeneroUsuario) throws FileNotFoundException
    {
    	
    	int generoDelDiscoEncontrado = 0;
    	int precioDiscoCostosoEncontrado = 0;
    	...
    	for(int i = 0;i<discos.size();i++) {
    		...
    		if( miDisco.darGenero().equals(pGeneroUsuario)) {
    			
    			generoDelDiscoEncontrado = generoDelDiscoEncontrado + 1;
    			...
    			if( miDisco.darPrecioDisco()>1000) {
    				...
    				precioDiscoCostosoEncontrado = precioDiscoCostosoEncontrado + 1;
    			}
    		}
    	}
    	
    	if(generoDelDiscoEncontrado > 0 && precioDiscoCostosoEncontrado > 0) {
    		
    		JOptionPane.showMessageDialog(null, "Disco con el género que ingreso encontrado");
    		pluma.close();
    ...
    public String metodo1( )
    {
        try {
			...
			return "Error fatal :c  "+e.getMessage();
		}
    }
    ...
    {
    	try {
    		String generoDado = JOptionPane.showInputDialog("Por favor ingrese un genero de musica:");
    		generarInformeDiscosCostosos(generoDado);
